...
export default function FindSkillsPage() {
            ...
            >
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {skill.slots.map((slot: any) => {
  if (!skill.canRequest) return null;

  if (slot.alreadyRequested) {
    return (
      <span
        key={slot.id}
  ...
  return (
    <button
      ...
      className="px-3 py-1 text-xs rounded-full border bg-[#eef2ea] hover:bg-[#4a5e27] hover:text-white transition"
    >

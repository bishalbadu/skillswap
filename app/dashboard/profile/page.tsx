...
//   async function deleteSkill(skill: string, type: string) {
...
//             color="green"
//             skills={skillsOffered.map((s: any) => s.name || s)}
...
//             color="yellow"
//             skills={skillsWanted.map((s: any) => s.name || s)}
...
//   const badgeColor = color === "green" ? "bg-[#d8dccf]" : "bg-[#f0d9b5]";

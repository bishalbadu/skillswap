...
{editable && (
  <button
    onClick={() =>
      router.push(`/dashboard/offer-skills?edit=${s.id}`)
    }
    className="text-xs underline text-[#4a5e27]"
  >
    {s.status === "PENDING" ? "Edit" : "Edit Slots"}
  </button>
)}
